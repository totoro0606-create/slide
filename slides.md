...
**高校生Aさん - 文化祭注文アプリ（1週間で完成）**

- スマホで注文 → タブレットに即座に表示
- 自動集計・会計機能付き
- 紙の伝票不要で行列解消

**使用ツール：** Glide + Googleスプレッドシート + LINE Notify
...
- 家庭菜園の収穫をスマホで記録
- ネット販売と連動し自動で在庫減・売上計上
- 家計簿機能で収支を一元管理

**使用ツール：** AppSheet + Googleスプレッドシート + Make

---

# 2-1. 初心者成功ストーリー（Cさん）

**会社員Cさん - SNS自動投稿ツール（副業収益化）**

- テンプレート + 画像生成を事前設定
- 複数SNSへの予約投稿を自動化
- 月額サービスとして他社に提供中

**使用ツール：** Glide + n8n + Canva API + ChatGPT
